...
- beneficiario: o nome de quem RECEBE o pagamento. Num boleto normal é o favorecido/beneficiário/cedente. Numa nota fiscal ou CT-e é o EMITENTE (quem vendeu/prestou o serviço/transporte — é ele que vai receber). Numa DARF, GPS ou outra guia de tributo federal/estadual (documento de arrecadação, sem cedente nomeado) o beneficiário é sempre o nome do órgão arrecadador (ex: "Receita Federal", "INSS") — NUNCA o nome/razão social do contribuinte que está pagando, mesmo que seja o único nome próprio visível no documento. Num comprovante de PIX/transferência (tipo="pago") tome cuidado especial pra não inverter quem paga e quem recebe: se o documento tiver os campos "Recebedor" e "Pagador", beneficiário é o nome no campo RECEBEDOR (nunca o Pagador). Se tiver os campos "De" e "Para" (ou "Origem"/"Destino"), "De" é quem ENVIOU o dinheiro (pagador) e "Para" é quem RECEBEU (beneficiário) — use sempre o nome que está em "Para".
